...
function ToDoList() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-900 to-blue-700">
      <div className="bg-gray-800 w-1/3 min-h-[75vh] max-h-[85vh] flex items-center flex-col p-6 rounded-2xl shadow-2xl gap-6">
        <h1 className="font-extrabold text-3xl text-white mb-4">مهامي</h1>
        ...
        <div className="w-full p-3 border border-gray-700 rounded-xl bg-gray-700 min-h-[30vh] max-h-[70vh] overflow-y-auto">
          <Outlet />
        </div>
        ...
        <div className="flex gap-3 w-full mt-4">
          <input
            ...
            className="border border-gray-500 p-3 rounded-lg w-full focus:outline-none focus:border-blue-500 transition-all duration-300"
            value={valueToADD}
            onChange={handleChange}
          />
          <button 
            className="bg-blue-600 text-white px-5 py-2 rounded-lg hover:bg-blue-500 transition-all duration-300" 
            onClick={handleAdd}
          >
            اضافة
          </button>
